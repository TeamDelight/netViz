...
def network_json_gen(cus_id):
    ...
    transaction_list2 = [{"transaction_type": row}
                         for row in string[14].split("|")]
    transaction_list3 = [{"transaction_amount": row}
                         for row in string[15].split("|")]
    transaction_list4 = [{"transaction_date": row}
                         for row in string[16].split("|")]
    ...
    network_json2_list = [network_account_json,
                          network_transaction_json, network_address_json]
